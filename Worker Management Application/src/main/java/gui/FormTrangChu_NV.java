...
public class FormTrangChu_NV extends JFrame implements ActionListener {
	 ...
	 * Create the frame.
	 */
	public FormTrangChu_NV(TaiKhoan tk) {
...
//			ImageIcon icon = new ImageIcon(image.getScaledInstance(250, 225, Image.SCALE_SMOOTH));
		...
		JLabel lblQuanLy = new JLabel("NHÂN VIÊN");
	    ...
	    this.getRootPane().getActionMap().put("Thoát", new AbstractAction() {
	        ...
	        public void actionPerformed(ActionEvent e) {
	            int resp = JOptionPane.showConfirmDialog(FormTrangChu_NV.this, "Bạn có chắc muốn thoát chương trình?", "Chú ý", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
	            if (resp == 0) {
	            	FormTrangChu_NV.this.setVisible(false);
	            	FormTrangChu_NV.this.dispose();
	            }
	        }
	    });
	}
		...
		if(o.equals(btnDoiMk)) {
			...
			form.addWindowListener(new WindowAdapter() {
				...
				public void windowClosed(WindowEvent e) {
					Frame[] frame = FormTrangChu_NV.getFrames();
